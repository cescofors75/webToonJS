...
export function Footer() {
  ...
  return (
    <footer className="border-t border-gray-200 dark:border-gray-700 py-12 px-6 bg-gray-50 dark:bg-gray-800 transition-colors">
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <h3 className="font-semibold mb-4 text-gray-900 dark:text-gray-100">{t.footer.links}</h3>
          ...
          <div>
            <h3 className="font-semibold mb-4 text-gray-900 dark:text-gray-100">{t.footer.resources}</h3>
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div>
            <h3 className="font-semibold mb-4 text-gray-900 dark:text-gray-100">{t.footer.community}</h3>
            <div className="flex space-x-4">
              <Link href="https://github.com/cescofors75" className="text-gray-600 dark:text-gray-400 hover:text-emerald-500">
                <Github className="w-5 h-5" />
              </Link>
              <Link href="https://linkedin.com/in/cescofors" className="text-gray-600 dark:text-gray-400 hover:text-emerald-500">
