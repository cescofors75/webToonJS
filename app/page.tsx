  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="container mx-auto text-center">
          <div className="inline-block mb-6 px-4 py-2 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 rounded-full text-sm font-medium">
            {t.home.badge}
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-sm text-gray-500 dark:text-gray-500 mt-1">Promedio en benchmarks</div>
            </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-6xl mx-auto">
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6 hover:shadow-lg transition-all">
              ...
              <pre className="bg-gray-50 dark:bg-gray-950 rounded p-4 overflow-x-auto text-sm">
                <code className="text-gray-800 dark:text-gray-200">{`data.filter(r => r.age > 25)
    .map(r => ({ ...r, senior: true }))`}</code>
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6 hover:shadow-lg transition-all">
              ...
              <pre className="bg-gray-50 dark:bg-gray-950 rounded p-4 overflow-x-auto text-sm">
                <code className="text-gray-800 dark:text-gray-200">{`data.groupBy('category', 'sum', 'sales')
// { electronics: 15000, books: 8500 }`}</code>
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6 hover:shadow-lg transition-all">
              ...
              <pre className="bg-gray-50 dark:bg-gray-950 rounded p-4 overflow-x-auto text-sm">
                <code className="text-gray-800 dark:text-gray-200">{`const corr = data.correlation('price', 'sales')
// 0.87 (strong positive correlation)`}</code>
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6 hover:shadow-lg transition-all">
              ...
              <pre className="bg-gray-50 dark:bg-gray-950 rounded p-4 overflow-x-auto text-sm">
                <code className="text-gray-800 dark:text-gray-200">{`data.rolling('price', 7, 'avg')
// Moving average of last 7 days`}</code>
            ...
            {/* Method 5: findAll */}
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6 hover:shadow-lg transition-all">
              <h3 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-2 font-mono">findAll() <span className="text-xs bg-emerald-100 dark:bg-emerald-900/50 px-2 py-1 rounded">NEW</span></h3>
              <p className="text-gray-600 dark:text-gray-400 mb-4">{t.home.methods.m5.desc}</p>
              <pre className="bg-gray-50 dark:bg-gray-950 rounded p-4 overflow-x-auto text-sm">
                <code className="text-gray-800 dark:text-gray-200">{`const matches = data.findAll(r => r.stock < 10)
// All products with low stock`}</code>
            ...
            {/* Method 6: countBy */}
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6 hover:shadow-lg transition-all">
              <h3 className="text-xl font-semibold text-emerald-600 dark:text-emerald-400 mb-2 font-mono">countBy() <span className="text-xs bg-emerald-100 dark:bg-emerald-900/50 px-2 py-1 rounded">NEW</span></h3>
              <p className="text-gray-600 dark:text-gray-400 mb-4">{t.home.methods.m6.desc}</p>
              <pre className="bg-gray-50 dark:bg-gray-950 rounded p-4 overflow-x-auto text-sm">
                <code className="text-gray-800 dark:text-gray-200">{`data.countBy('status')
      ...
      <section className="py-20 px-6 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-6 border border-gray-200 dark:border-gray-800 rounded-lg hover:border-emerald-500 transition-all hover:shadow-lg bg-white dark:bg-gray-950">
