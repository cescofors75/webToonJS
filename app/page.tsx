...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-sm text-gray-500 mt-1">En operaciones numéricas</div>
            </div>
            <div className="flex flex-col items-center justify-center">
              <NpmDownloads />
              <div className="text-gray-600 mt-2">{t.home.stats.downloads}</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* WASM Section */}
      <section className="py-12 bg-emerald-900 text-white overflow-hidden relative">
         <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex items-center gap-4">
               ...
               <div>
                  <h3 className="text-2xl font-bold mb-1">{t.home.wasm.title}</h3>
                  <p className="text-emerald-100 max-w-xl">{t.home.wasm.desc}</p>
               </div>
            </div>
